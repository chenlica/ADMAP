...
public class Keys {
    ...
    public static final UniqueKey<MetadataRecord> METADATA_PKEY = Internal.createUniqueKey(Metadata.METADATA, DSL.name("metadata_pkey"), new TableField[] { Metadata.METADATA.MID }, true);
    public static final UniqueKey<MetadataContributorRecord> METADATA_CONTRIBUTOR_PKEY = Internal.createUniqueKey(MetadataContributor.METADATA_CONTRIBUTOR, DSL.name("metadata_contributor_pkey"), new TableField[] { MetadataContributor.METADATA_CONTRIBUTOR.CID }, true);
    public static final UniqueKey<MetadataFunderRecord> METADATA_FUNDER_PKEY = Internal.createUniqueKey(MetadataFunder.METADATA_FUNDER, DSL.name("metadata_funder_pkey"), new TableField[] { MetadataFunder.METADATA_FUNDER.FID }, true);
    public static final UniqueKey<MetadataSpecimenRecord> METADATA_SPECIMEN_PKEY = Internal.createUniqueKey(MetadataSpecimen.METADATA_SPECIMEN, DSL.name("metadata_specimen_pkey"), new TableField[] { MetadataSpecimen.METADATA_SPECIMEN.SID }, true);
    ...
    public static final ForeignKey<MetadataRecord, UserRecord> METADATA__METADATA_OWNER_UID_FKEY = Internal.createForeignKey(Metadata.METADATA, DSL.name("metadata_owner_uid_fkey"), new TableField[] { Metadata.METADATA.OWNER_UID }, Keys.USER_PKEY, new TableField[] { User.USER.UID }, true);
    public static final ForeignKey<MetadataContributorRecord, MetadataRecord> METADATA_CONTRIBUTOR__METADATA_CONTRIBUTOR_METADATA_ID_FKEY = Internal.createForeignKey(MetadataContributor.METADATA_CONTRIBUTOR, DSL.name("metadata_contributor_metadata_id_fkey"), new TableField[] { MetadataContributor.METADATA_CONTRIBUTOR.METADATA_ID }, Keys.METADATA_PKEY, new TableField[] { Metadata.METADATA.MID }, true);
    public static final ForeignKey<MetadataFunderRecord, MetadataRecord> METADATA_FUNDER__METADATA_FUNDER_METADATA_ID_FKEY = Internal.createForeignKey(MetadataFunder.METADATA_FUNDER, DSL.name("metadata_funder_metadata_id_fkey"), new TableField[] { MetadataFunder.METADATA_FUNDER.METADATA_ID }, Keys.METADATA_PKEY, new TableField[] { Metadata.METADATA.MID }, true);
    public static final ForeignKey<MetadataSpecimenRecord, MetadataRecord> METADATA_SPECIMEN__METADATA_SPECIMEN_METADATA_ID_FKEY = Internal.createForeignKey(MetadataSpecimen.METADATA_SPECIMEN, DSL.name("metadata_specimen_metadata_id_fkey"), new TableField[] { MetadataSpecimen.METADATA_SPECIMEN.METADATA_ID }, Keys.METADATA_PKEY, new TableField[] { Metadata.METADATA.MID }, true);
